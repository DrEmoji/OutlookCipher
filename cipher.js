...
function applyPKCSv2Padding(e, t, n) {
    var a, o = e.length,
        i = [218, 57, 163, 238, 94, 107, 75, 13, 50, 85, 191, 239, 149, 96, 24, 144, 175, 216, 7, 9],
        r = t - o - 40 - 2,
        s = [];
    for (a = 0; r > a; a++) {
        s[a] = 0
...
function SHA1(e) {
    ...
    var o = [];
    return wordToBytes(a.A, o, 0), wordToBytes(a.B, o, 4), wordToBytes(a.C, o, 8), wordToBytes(a.D, o, 12), wordToBytes(a.E, o, 16), o
}
...
function byteArrayToBase64(e) {
    ...
    return 1 == i ? o = o + base64Encode(n << 16, 2) + "==" : 2 == i && (o = o + base64Encode(n << 8, 3) + "="), o
}
...
function normalizeJSMP(e) {
    ...
    for (a = e.size, n = 0, t = 0; a > t; t++) {
        o = e.data[t], o += n, i = o, n = Math.floor(o / 65536), o -= 65536 * n, e.data[t] = o
    }
}
...
function multiplyAndSubtract(e, t, n, a) {
    var o, i = e.data.slice(0),
        r = 0,
        s = e.data;
    for (o = 0; o < n.size; o++) {
        var l = r + n.data[o] * t;
        r = l >>> 16, l -= 65536 * r, l > s[o + a] ? (s[o + a] += 65536 - l, r++) : s[o + a] -= l
    }
    return r > 0 && (s[o + a] -= r), s[o + a] < 0 ? (e.data = i.slice(0), -1) : 1
}
